...
function Home() {
  ...
  /* =====================================================
     CONTINUOUS TYPING / FOLD EFFECT LOGIC (Never Stops)
  ===================================================== */
  const wordsToType = useMemo(
    () => ["AI Smart Hospital", "Next-Gen Healthcare", "Smart Diagnosis"],
    []
  );
  ...
  useEffect(() => {
    ...
    if (!isDeleting && charIdx <= currentWord.length) {
      timer = setTimeout(() => {
        setTypedWord(currentWord.substring(0, charIdx));
      ...
      timer = setTimeout(() => {
        setTypedWord(currentWord.substring(0, charIdx - 1));
        setCharIdx((prev) => prev - 1);
      }, 45);
    } else if (isDeleting && charIdx === 0) {
      setIsDeleting(false);
  ...
  }, [charIdx, isDeleting, wordIdx, wordsToType]);
  ...
  return (
    ...
    >
      ...
      {/* =====================================================
          PROJECT INTRODUCTION (Single Line Header & Full Grid)
      ===================================================== */}
        ...
        <div className="project-intro-container">
          ...
          <div className="project-intro-top">
            <div className="project-intro-badge">
              ...
              <span>EDUCATIONAL COLLEGE PROJECT</span>
            </div>
          ...
          {/* MAIN PROJECT CONTENT (Fold Typing Effect) */}
          <div className="project-intro-main" style={{ display: "flex", flexDirection: "column", gap: "1.4rem", width: "100%" }}>
            
            <div className="project-intro-heading" style={{ width: "100%" }}>
            ...
            {/* Grid paragraphs below the title */}
            <div className="project-intro-paragraphs" style={{ 
              display: "grid", 
              ...
              <p className="project-intro-lead" style={{ margin: 0, fontSize: "1.05rem", lineHeight: "1.7", color: "var(--text-secondary, #52616b)" }}>
              ...
              <div className="project-intro-description" style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
                <p style={{ margin: 0, fontSize: "0.98rem", lineHeight: "1.65", color: "var(--text-secondary, #52616b)" }}>
          ...
          <div className="project-intro-footer">
            <div className="project-purpose">
              ...
              <div>
                ...
                <strong>Learning • Experimentation • Innovation</strong>
              </div>
            </div>
        ...
        <div className="doctors-grid">
          <div className="doctor-card">
            ...
            <div className="doctor-info">
              <span className="doctor-available">● AVAILABLE TODAY</span>
              <h3>Dr. Rajesh Sharma</h3>
              <p>Cardiologist</p>
              <small>12+ years of experience in cardiovascular care.</small>
          ...
          <div className="doctor-card">
            ...
            <div className="doctor-info">
              ...
              <p>Neurologist</p>
              <small>Specialist in neurological diagnosis and treatment.</small>
              <div className="doctor-bottom">
                <span>★★★★★</span>
                <span>10+ Years</span>
              </div>
          ...
          <div className="doctor-card">
            ...
            <div className="doctor-info">
              ...
              <small>Expert in bone, joint and musculoskeletal care.</small>
              <div className="doctor-bottom">
                <span>★★★★★</span>
                <span>11+ Years</span>
              </div>
          ...
          <div className="doctor-card">
            ...
            <div className="doctor-info">
              ...
              <p>Pediatrician</p>
              <small>Dedicated to children's healthcare and wellbeing.</small>
              <div className="doctor-bottom">
                <span>★★★★★</span>
                <span>9+ Years</span>
              </div>
        ...
        <div className="about-container">
          ...
          <div className="about-main">
            <div className="about-information">
              <p className="about-small-title">OUR VISION</p>
              <h3>
                Building a smarter
              ...
              <div className="about-feature-list">
                <div className="about-feature-item">
                  ...
                  <div>
                    <strong>Digital Appointment Management</strong>
                    <small>Easy and organized appointment booking</small>
                  </div>
                </div>
                ...
                <div className="about-feature-item">
                  ...
                  <div>
                    ...
                    <small>Manage important healthcare information</small>
                  </div>
                </div>
                ...
                <div className="about-feature-item">
                  ...
                  <div>
                    ...
                    <small>Connect patients with medical professionals</small>
                  </div>
                </div>
                ...
                <div className="about-feature-item">
                  <span className="feature-check">✓</span>
                  <div>
                    <strong>AI Healthcare Assistance</strong>
                    <small>Intelligent healthcare information support</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="ai-chatbot">
              <div className="ai-chat-header">
                <div className="ai-chat-profile">
                  <div className="chat-ai-logo">AI</div>
                  <div>
                    <strong>AI Healthcare Assistant</strong>
                    <span>Online • Smart Hospital Support</span>
                  </div>
                </div>
              ...
              <div className="ai-chat-body">
                {chatMessages.map((message, index) => (
                  ...
                  >
                    {message.sender === "bot" && (
                      <div className="message-ai-icon">AI</div>
                    )}
              ...
              <div className="chat-quick-section">
                ...
                <div className="chat-quick-buttons">
                  <button
                    type="button"
                    onClick={() => askChatQuestion("What is your website?")}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => askChatQuestion("What services do you provide?")}
                  >
                    Our services
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => askChatQuestion("Who are your doctors?")}
                  >
                    Doctors
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => askChatQuestion("Tell me about Ayushman Bharat")}
                  >
                    Ayushman Bharat
                  </button>
                </div>
      ...
      <section className="support-section" id="contact">
        <div className="support-container">
          <div className="support-heading">
            <span className="support-label">PATIENT SUPPORT</span>
            <h2>We're Here <span>To Help</span></h2>
            <p>
          ...
          <div className="support-options">
            <div className="support-card">
              <div className="support-icon phone-icon">☎</div>
              <div className="support-card-content">
                <span className="support-small">TALK TO US</span>
                <h3>Call Hospital</h3>
                <p>Speak directly with our hospital support team.</p>
                <a href="tel:+919999999999" className="support-button">
                  Call Hospital →
                </a>
              </div>
            </div>
            ...
            <div className="support-card">
              <div className="support-icon email-icon">✉</div>
              <div className="support-card-content">
                <span className="support-small">GET IN TOUCH</span>
                <h3>Email Support</h3>
                <p>Send us your questions and we'll get back to you.</p>
                <a href="mailto:support@aismarthospital.com" className="support-button">
                  Email Support →
                </a>
              </div>
            </div>
            ...
            <div className="support-card emergency-card">
              ...
              <div className="support-icon emergency-icon">!</div>
              <div className="support-card-content">
                <span className="support-small">EMERGENCY SERVICES</span>
                <h3>Emergency 108</h3>
                <p>
                  For urgent medical emergencies, get immediate assistance.
                </p>
                <a href="tel:108" className="emergency-button">
                  Call 108 →
                </a>
              </div>
            </div>
          ...
          <div className="support-footer">
            ...
            <span>AI Smart Hospital Support is available 24/7</span>
          </div>
        </div>
      </section>
      ...
      <footer className="home-footer">
        <div className="footer-main">
          ...
          <div className="footer-contact">
            ...
            <a href="tel:108" className="footer-emergency">
              <div className="emergency-icon">!</div>
              <div>
                <strong>Emergency Support</strong>
                <span>Call 108 • Available 24/7</span>
              </div>
              <b>→</b>
            </a>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-credit">
            <p>© 2026 <strong>AI Smart Hospital</strong></p>
            <span>Academic Project • TY BCA • Healthcare Technology</span>
          </div>
      ...
      {loginOpen && (
        ...
        >
          ...
          >
            ...
            <p className="login-subtitle">Login to AI Smart Hospital</p>
            ...
            {errorMessage && (
              <div className="login-error">⚠️ {errorMessage}</div>
            )}
            ...
            <form
              onSubmit={async (e) => {
                ...
                if (!/^[A-Za-z ]{2,50}$/.test(fullName)) {
                  setRegisterError("Please enter a valid full name using letters only.");
                  return;
                }
                ...
                if (!/^[6-9][0-9]{9}$/.test(mobile)) {
                  setRegisterError("Mobile number must be exactly 10 digits and start with 6-9.");
                  return;
                }
                ...
                if (!strongPassword) {
                  setRegisterError("Password must be 8+ characters and include uppercase, lowercase, number and special character.");
                  return;
                }
